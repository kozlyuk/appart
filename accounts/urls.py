...
urlpatterns = [
    ...
    path("api/v1/activate/<str:uidb64>/<str:token>/", api.ActivateEmail.as_view(), name='activate_email'),
    path("api/v1/activate/<str:otp>/", api.ActivateSMS.as_view(), name='activate_sms'),
